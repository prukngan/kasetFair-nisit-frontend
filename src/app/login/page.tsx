...
//   if (!raw) return false
//   try {
//     const u = new URL(raw, typeof window !== "undefined" ? window.location.origin : process.env.NEXTAUTH_URL)
...
//   const callbackUrl = isSafeCallback(callbackUrlParam) ? callbackUrlParam! : "/"
