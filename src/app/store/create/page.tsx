    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-100 px-4 py-12">
          <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-4 rounded-3xl bg-white/80 p-10 text-center shadow-xl ring-1 ring-emerald-100">
            <div className="h-3 w-24 rounded-full bg-emerald-100 animate-pulse" />
            <p className="text-sm text-emerald-700">Loading store creation...</p>
          </div>
        </div>
      }
    >
...
function StoreCreatePageContent() {
